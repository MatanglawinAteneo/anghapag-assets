const scenes = [
    {
      ...
      typing: true,
      showRitual: true,
      ritualQuestion: "Para makamtan ang iyong unang kakanin, ialay sa ibaba ang pangalan ng iyong iniidolo o labis mong hinahangaan.",
    ...
    },
    {
      ...
      textOffsetY: "1.35rem",
      uiTopPadding: "3.6rem",
      text: "Tinig: Nawa’y masiyahan ka sa aming inihain. Narito ang pambansang paborito. Anuman ang ilagay mo, tiyak na papatok at kakagat ang lahat.",
      showCloche: true,
      showMeal: true,
      postTypingEffect: "clocheLift",
      clocheLiftDelayMs: 540,
  ...
  function startHallucinationRedirect() {
    ...
    setTimeout(() => {
      window.location.href = "https://www.matanglawin-ateneo.com/ang-hapag/unang-lunok";
    }, 3200);
  }
  ...
  (function () {
    ...
    const ASSETS = [
      ...
      { type: "image", url: "https://raw.githubusercontent.com/MatanglawinAteneo/anghapag-assets/main/adobo.png" },
